...
<?php include'nav.php';?>
<div class="bnr_cntnr">
  <div class="tp_lnk_cntnr"><a href="all.php" class="menu_sub">ALL</a> <a href="locations.php" class="menu_sub">MANAHATTAN</a> <a href="connecticut.php" class="menu_sub">CONNECTICUT</a> <a href="texas.php" class="menu_sub_current">TEXAS</a> </div>
</div>
<!------------ Menu Left -------------->
<div class="abt_main">
<div class="abt_brdr">
